...
@else
    <section class="sidebar-content-area archive-filters">
@endif
    ...
    <form method="get" action="{{ $archiveUrl }}" id="archive-filter">
        ...
        <div class="grid">
            ...
            <div class="grid-sm-12 grid-md-auto  u-mb-1@xs u-mb-1@sm">
            ...
            @if (isset($enabledTaxonomyFilters->primary) && !empty($enabledTaxonomyFilters->primary))
                ...
                <div class="grid-sm-12  u-mb-1@xs u-mb-2@sm {{ $tax->type == 'multi' ? 'grid-md-fit-content' : 'grid-md-auto' }}">
            ...
            @endif
            <div class="grid-sm-12 grid-md-fit-content u-flex">
                <input type="submit" value="<?php _e('Search', 'municipio'); ?>" class="btn btn-primary btn-block u-my-0">
            </div>
        </div>
